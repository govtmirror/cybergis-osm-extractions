...
#===================#
#Raw (Nodes and Ways)
LG=nyaruguru_raw_$TIMESTAMP
FTA=( "nyaruguru_raw_node" "nyaruguru_raw_way")
SNAPA=()
...
LG=nyaruguru_normal_$TIMESTAMP
FTA=( "nyaruguru_basic_osm_buildings" "nyaruguru_basic_osm_roads" )
SNAPA=()
